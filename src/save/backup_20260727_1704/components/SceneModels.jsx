...
export default function SceneModels({
  ...
  const airBalloon1 = useGLTF('/glb/airBalloon1.glb') 
  const airBalloon2 = useGLTF('/glb/airBalloon2.glb') 
  const airBalloon3 = useGLTF('/glb/airBalloon3.glb') 
  
  // ADDED: Load new balloon string glbs
  const balloonString0 = useGLTF('/glb/balloonString0.glb')
  const balloonString1 = useGLTF('/glb/balloonString1.glb')
  const balloonString2 = useGLTF('/glb/balloonString2.glb')
  const balloonString3 = useGLTF('/glb/balloonString3.glb')
  const balloonString4 = useGLTF('/glb/balloonString4.glb')
  const balloonString5 = useGLTF('/glb/balloonString5.glb')
  ...
  useMemo(() => {
    ...
    // Removed the flyaway renaming traverse loop so we don't break the string/sphere linkage
  }, [train.scene])
  
  // THE ORPHANED CODE BLOCK WAS REMOVED HERE
    ...
    <group>
      ...
      <StaticScenery 
        models={{ 
          ...
          balloonString0, balloonString1, balloonString2, balloonString3, balloonString4, balloonString5, // ADDED HERE
      ...
      />
	  {/* ADDED: Fireflies in the 1.0 PI to 1.4 PI range */}
      <Fireflies />
	  
	  <OceanAudio />
	  
	  {/* NEW: Water Sparks Effect rendering from the separate file */}
      <WaterSparks 
        trainCenter={trainCenter} 
        baseRadius={trainRadius+8} 
      />
...
useGLTF.preload('/glb/airBalloon1.glb') 
useGLTF.preload('/glb/airBalloon2.glb') 
useGLTF.preload('/glb/airBalloon3.glb') 
useGLTF.preload('/glb/balloonString0.glb') // ADDED
useGLTF.preload('/glb/balloonString1.glb') // ADDED
useGLTF.preload('/glb/balloonString2.glb') // ADDED
useGLTF.preload('/glb/balloonString3.glb') // ADDED
useGLTF.preload('/glb/balloonString4.glb') // ADDED
useGLTF.preload('/glb/balloonString5.glb') // ADDED
