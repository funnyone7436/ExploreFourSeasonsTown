...
export default function SceneModels({
  ...
  const boatRef = useRef()    // Add this
  const whaleRef = useRef()   // Add this
  ...
  useCharacterAnimations(catActions, girlActions, squirrelActions, seagullActions)
  ...
  // Notice how much cleaner this is! The same reusable hook handles all 3 trees
  ...
  useWaterAnimation(boatRef, whaleRef) // Add this
  // ------------------------------------------
