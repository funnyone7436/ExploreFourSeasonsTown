...
export default function SceneModels({
  ...
  const airBalloon1 = useGLTF('/glb/airBalloon1.glb') // ADDED
  const airBalloon2 = useGLTF('/glb/airBalloon2.glb') // ADDED
  const airBalloon3 = useGLTF('/glb/airBalloon3.glb') // ADDED
    ...
    <group>
      ...
      <StaticScenery 
        models={{ 
          ...
          airBalloon, airBalloon1, airBalloon2, airBalloon3, // ADDED HERE
...
useGLTF.preload('/glb/airBalloon1.glb') // ADDED
useGLTF.preload('/glb/airBalloon2.glb') // ADDED
useGLTF.preload('/glb/airBalloon3.glb') // ADDED
