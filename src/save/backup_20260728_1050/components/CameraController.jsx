...
export default function CameraOrbitController({ initialAngle = 0, isAutoMode = false }) {
  ...
  useFrame(() => {
    ...
    if (isAutoMode) {
      // AUTO MOVING MODE
      const autoSpinSpeed = 0.005; // Adjust for faster or slower rotation
      controls.setAzimuthalAngle(controls.getAzimuthalAngle() + autoSpinSpeed)
    } else {
