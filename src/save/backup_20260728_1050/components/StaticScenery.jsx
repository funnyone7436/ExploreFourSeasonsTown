...
export default function StaticScenery({
  ...
  const p = useMemo(() => {
    ...
    const getFlyPos = (piAngle) => {
      ...
      return [getX(angle), height + 9, getZ(angle)];
    };
    ...
    return {
      ...
      flyaway0: { pos: getFlyPos(0.96*Math.PI), rot: [0, 0, 0], scale: 1 },
      flyaway1: { pos: getFlyPos(0.96*Math.PI), rot: [0, 0, 0], scale: 1 },
      flyaway2: { pos: getFlyPos(0.96*Math.PI), rot: [0, 0, 0], scale: 1 },
      flyaway3: { pos: getFlyPos(0.96*Math.PI), rot: [0, 0, 0], scale: 1 },
      flyaway4: { pos: getFlyPos(0.96*Math.PI), rot: [0, 0, 0], scale: 1 },
      flyaway5: { pos: getFlyPos(0.96*Math.PI), rot: [0, 0, 0], scale: 1 },
