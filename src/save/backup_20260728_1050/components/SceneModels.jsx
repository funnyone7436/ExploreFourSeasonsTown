...
export default function SceneModels({
  ...
  useMemo(() => {
    ...
    // Clean and simple mesh renaming
...
useGLTF.preload('/glb/balloonString0.glb') 
useGLTF.preload('/glb/balloonString1.glb') 
useGLTF.preload('/glb/balloonString2.glb') 
useGLTF.preload('/glb/balloonString3.glb') 
useGLTF.preload('/glb/balloonString4.glb') 
useGLTF.preload('/glb/balloonString5.glb') 
