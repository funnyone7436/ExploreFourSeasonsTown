...
export default function useWaterAnimation(boatRef, whaleRef) {
  const config = {
    ...
    whale: { speed: 0.03, radius: 123.5, center: [0, 8.2, 0], yOffset: -8, yAmplitude: 1.0, ySpeed: 1.2, blowholeYOffset: 1.8, hideStart: 0.5 * Math.PI, hideEnd: 1.9 * Math.PI, angleOffset: Math.PI, rotationOffset: 0 }
  };
