...
if (bookStoreRef && bookStoreRef.current) {
  ...
  const leafConfig = {
    ...
    'Flower_Round_02_Red_Vein_04':  { limit: 60, speed: 1, arcHeight: 1.8, swing: 0.7, type: 'flower', key: 'Flower2' },
    'Flower_Round_03_Yellow_Vein_02': { limit: 20, speed: 1, arcHeight: 1.7, swing: .8, type: 'flower', key: 'Flower3' },
    'Flower_Round_04_Blue_Vein_02': { limit: 50, speed: 1, arcHeight: 1.6, swing: 1., type: 'flower', key: 'Flower4' }
  };
