...
// OPTIMIZATION: Hoisted static Math calculations outside the component
// to prevent the engine from recalculating them 60 times per second.
...
// --- APPLY SKY SHADER LOGIC ---
    ...
    // --- APPLY TO SUN ---
    if (sunRef.current) {
      // OPTIMIZATION: Used static PI constants
