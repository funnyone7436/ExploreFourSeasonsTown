...
export default function SceneModels({
  ...
  const bookStoreRef = useRef() // 1. ADDED REFERENCE HERE
  ...
  const redCarAngle = offsetAngle - 0.18
  const redCarPos = [getX(redCarAngle) + 25, height + 3, getZ(redCarAngle) - 25] 
