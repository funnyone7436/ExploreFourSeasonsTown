...
export default function useSceneAnimations(
  ...
  useFrame((state) => {
    ...
    if (bigTreeRef && bigTreeRef.current) {
      ...
      const bigTreeConfig = {
        'Leaf_DarkGreen_Bent':       { limit: defaultLimit, speed: 5.2, amplitude: 0.45, type: 'petal', key: 'DGB' },
        'Leaf_DarkGreen_Long':       { limit: higherLimit,  speed: 3.7, amplitude: 0.72, type: 'petal', key: 'DGL' },
        'Leaf_DarkGreen_Standard':   { limit: defaultLimit, speed: 7.1, amplitude: 0.38, type: 'petal', key: 'DGS' },
        'Leaf_DarkGreen_Wide':       { limit: defaultLimit, speed: 4.4, amplitude: 0.61, type: 'petal', key: 'DGW' },
        'Leaf_LightGreen_Bent':      { limit: defaultLimit, speed: 2.8, amplitude: 0.55, type: 'petal', key: 'LGB' },
        'Leaf_LightGreen_Long':      { limit: higherLimit,  speed: 6.5, amplitude: 0.29, type: 'petal', key: 'LGL' },
        'Leaf_LightGreen_Standard':  { limit: defaultLimit, speed: 5.9, amplitude: 0.78, type: 'petal', key: 'LGS' },
        'Leaf_LightGreen_Wide':      { limit: defaultLimit, speed: 3.1, amplitude: 0.42, type: 'petal', key: 'LGW' },
        'Leaf_MidGreen_Bent':        { limit: defaultLimit, speed: 7.6, amplitude: 0.66, type: 'petal', key: 'MGB' },
        'Leaf_MidGreen_Long':        { limit: higherLimit,  speed: 4.9, amplitude: 0.31, type: 'petal', key: 'MGL' },
        'Leaf_MidGreen_Standard':    { limit: defaultLimit, speed: 2.3, amplitude: 0.59, type: 'petal', key: 'MGS' },
        'Leaf_MidGreen_Wide':        { limit: defaultLimit, speed: 6.2, amplitude: 0.24, type: 'petal', key: 'MGW' },
        'Leaf_YellowGreen_Bent':     { limit: higherLimit,  speed: 3.8, amplitude: 0.75, type: 'petal', key: 'YGB' },
        'Leaf_YellowGreen_Long':     { limit: defaultLimit, speed: 5.5, amplitude: 0.48, type: 'petal', key: 'YGL' },
        'Leaf_YellowGreen_Standard': { limit: defaultLimit, speed: 7.9, amplitude: 0.35, type: 'petal', key: 'YGS' },
        'Leaf_YellowGreen_Wide':     { limit: defaultLimit, speed: 4.1, amplitude: 0.69, type: 'petal', key: 'YGW' }
      };
